...
from .views import PortfolioView, ClassRoomView, ClassRoomCreateView, UpdateClassRoomView, DeleteClassRoomView
...
urlpatterns=[
    ...
    path('profile/<int:pk>/', UserProfileView.as_view(), name="classbased_user_profile"),
]